...
for src in cusolvermp_common.cc cusolvermp_common.h cusolvermp_gels.cc cusolvermp_gesvd.cc cusolvermp_lu_solve.cc cusolvermp_potrs.cc cusolvermp_routines.h cusolvermp_syevd.cc potrs_logdet.cu.cc potrs_logdet.h; do
